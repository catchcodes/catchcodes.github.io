...
R.sources = 
[
	{id:"mainbg", size:456, src:"fish_images/game_bg_2_hd.jpg?"+Math.random()},
	{id:"bottom", size:50, src:"fish_images/bottom.png?"+Math.random()},
	{id:"fish1", size:6, src:"fish_images/fish1.png?"+Math.random()},
	{id:"fish2", size:16, src:"fish_images/fish2.png?"+Math.random()},
	{id:"fish3", size:11, src:"fish_images/fish3.png?"+Math.random()},
	{id:"fish4", size:15, src:"fish_images/fish4.png?"+Math.random()},
	{id:"fish5", size:43, src:"fish_images/fish5.png?"+Math.random()},
	{id:"fish6", size:45, src:"fish_images/fish6.png?"+Math.random()},
	{id:"fish7", size:80, src:"fish_images/fish7.png?"+Math.random()},
	{id:"fish8", size:100, src:"fish_images/fish8.png?"+Math.random()},
	{id:"fish9", size:104, src:"fish_images/fish9.png?"+Math.random()},
	{id:"fish10", size:121, src:"fish_images/fish10.png?"+Math.random()},
	{id:"shark1", size:287, src:"fish_images/shark1.png?"+Math.random()},
	{id:"shark2", size:382, src:"fish_images/shark2.png?"+Math.random()},
	{id:"cannon1", size:11, src:"fish_images/cannon1.png?"+Math.random()},
	{id:"cannon2", size:11, src:"fish_images/cannon2.png?"+Math.random()},
	{id:"cannon3", size:11, src:"fish_images/cannon3.png?"+Math.random()},
	{id:"cannon4", size:13, src:"fish_images/cannon4.png?"+Math.random()},
	{id:"cannon5", size:13, src:"fish_images/cannon5.png?"+Math.random()},
	{id:"cannon6", size:15, src:"fish_images/cannon6.png?"+Math.random()},
	{id:"cannon7", size:17, src:"fish_images/cannon7.png?"+Math.random()},
	{id:"bullet", size:8, src:"fish_images/bullet.png?"+Math.random()},
	{id:"web", size:93, src:"fish_images/web.png?"+Math.random()},
	{id:"numBlack", size:1, src:"fish_images/number_black.png?"+Math.random()},
	{id:"coinAni1", size:19, src:"fish_images/coinAni1.png?"+Math.random()},
	{id:"coinAni2", size:22, src:"fish_images/coinAni2.png?"+Math.random()},
	{id:"coinText", size:16, src:"fish_images/coinText.png?"+Math.random()}
];
